        ...
        <tbody>
            {bookArr.map(book=><tr key={book.id}>
              ...
              <td>
                ...
                <button type="button" className="btn btn-primary"  id = "view" name="view ">
                ...
                <button type="button" className="btn btn-success" id = "edit" name="edit">
                ...
                <button type="button" className="btn btn-danger"  id = "delete" name="delete" onClick={()=>{deleteBook(book.id)}}>
